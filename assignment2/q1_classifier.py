...
class SoftmaxModel(Model):
    ...
    def add_prediction_op(self):
        ...
        """
        ### YOUR CODE HERE
        W = tf.get_variable("W", shape=[self.config.n_features, self.config.n_classes], initializer=tf.zeros_initializer)
        b = tf.get_variable("b", shape=self.config.n_classes, initializer=tf.zeros_initializer)
